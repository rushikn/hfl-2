...
def results_to_natural_language(results, user_query):
    ...
    prompt_text = (
        ...
        "Avoid explanations and unit information. Output only relevant values. Example: 'The unique billing count for yesterday is 3421.'\n\n"
        "Answer:"
    )
    ...
    try:
        ...
        # Strip all decimal parts: keep only the integer portion
